...
import {
  ...
  setUserStatusIntoState,
} from "../authUserData/actionCreators";
import { initializedApp } from "../initializedApp/actionCreators";

export const logOutThunkCreator = (/* email, password, rememberMe = false, captcha = false */) => async (
  dispatch
) => {
