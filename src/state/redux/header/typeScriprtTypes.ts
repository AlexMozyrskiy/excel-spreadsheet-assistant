...
import { RootReducerSate as RootReducerSateTSType } from "../store";
import {
    IsLoginButtonClicked as IsLoginButtonClickedTSType,
    IsSearchButtonClicked as IsSearchButtonClickedTSType
} from "../commonTSTypes";
